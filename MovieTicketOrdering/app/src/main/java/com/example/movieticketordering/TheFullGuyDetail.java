...
public class TheFullGuyDetail extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_full_guy_detail);
    ...
    public void onClick(View view){
        ...
        if(view.getId()==R.id.button) {
            TheFullGuyDetail.SharedViewModel.setTicketTitle("FallGuy");
        ...
        if (view.getId() == R.id.movieposter){
            ...
            intent.setData(Uri.parse("https://www.youtube.com/watch?v=j7jPnwVGdZ8"));
            startActivity(intent);
            finish();
        }
