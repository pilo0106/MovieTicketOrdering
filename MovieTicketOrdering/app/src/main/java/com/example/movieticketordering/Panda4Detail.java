...
public class Panda4Detail extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panda4_detail);
    ...
    public void onClick(View view){
        ...
        if(view.getId()==R.id.button) {
            GodzillaDetail.SharedViewModel.setTicketTitle("Panda4");
        ...
        if (view.getId() == R.id.movieposter){
            ...
            intent.setData(Uri.parse("https://www.youtube.com/watch?v=_inKs4eeHiI&pp=ygUPa3VuZyBmdSBwYW5kYSA0"));
            startActivity(intent);
            finish();
        }
    }
